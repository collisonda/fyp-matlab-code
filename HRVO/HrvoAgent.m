classdef HrvoAgent
    ...
    methods (Access = public)
        function obj = HrvoAgent(x0,y0,xg,yg,iAgent)
        ...
        function obj = addneighbour(obj,Neighbour)
            ...
            [nx, ny] = createarc(obj.heading + AgentConstants.VO_VISION_ANGLE,...
                obj.heading - AgentConstants.VO_VISION_ANGLE,obj.position(1),...
        ...
        function [heading, Velocity] = calcaction(obj)
            if isempty(obj.neighbourIds) % No neighbours to worry about, go full speed at the goal.
                ...
                for iNeighbour = 1:length(obj.neighbourIds)
                    ...
                    [VO_j] = obj.define2DHybridReciprocalVelocityObstacle(p_i,v_i,r_i,p_j,v_j,r_j,tau_j);
...
%                 Velocity = obj.matchvelocity(Velocity);
        ...
        function [VO] = define2DVelocityObstacle(obj,p_i,v_i,r_i,p_j,v_j,r_j,tau)
            ...
            VO = obj.define3DVelocityObstacle(p_a,v_a,r_a,p_b,v_b,r_b,tau);
        ...
        function [RVO] = define2DReciprocalVelocityObstacle(obj,p_i,v_i,r_i,p_j,v_j,r_j,tau_j)
            ...
            p_j = [p_j;0]; v_j = [v_j;0];
            % CALL THE 3D VO GENERATION FUNCTION
            [RVO] = obj.define3DReciprocalVelocityObstacle(p_i,v_i,r_i,p_j,v_j,r_j,tau_j);
        ...
        function [RVO] = define3DReciprocalVelocityObstacle(obj,p_i,v_i,r_a,p_j,v_j,r_b,tau_b)
            ...
            [RVO] = obj.define3DVelocityObstacle(p_i,v_i,r_a,p_j,v_j,r_b,tau_b);
            % ////// DEFINE RECIPROCAL VELOCITY OBSTACLE PARAMETERS ///////
            RVO.apex = (v_i + v_j)/2; % Modify the apex position
        end
        
        function [VO] = define3DVelocityObstacle(obj,p_a,v_a,r_a,p_b,v_b,r_b,tau)
            ...
            % OBSTACLE KNOWLEDGE
            lambda_ab = p_b - p_a;
            r_c = r_a + r_b + 4;        % Configuration radius with a small tolerance offset
            ...
            [leadingTangentVector] = obj.rodriguesRotation(lambda_ab,planarNormal,halfAlpha);
        ...
        function [RVO] = define2DHybridReciprocalVelocityObstacle(obj,p_i,v_i,r_i,p_j,v_j,r_j,tau)
            [VO]  = obj.define2DVelocityObstacle(p_i,v_i,r_i,p_j,v_j,r_j,tau);
            [RVO] = obj.define2DReciprocalVelocityObstacle(p_i,v_i,r_i,p_j,v_j,r_j,tau);
        ...
        function [p_inter,isSuccessful] = findAny2DIntersection(obj,P1,dP1,P2,dP2)
