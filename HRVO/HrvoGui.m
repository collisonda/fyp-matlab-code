...
set(gca, 'FontSize', 12)
        ...
        function obj = generateagentgraphic(obj,Agent)
            ...
            [nx, ny] = createarc(Agent.heading + ...
                AgentConstants.VO_VISION_ANGLE,Agent.heading - ...
                AgentConstants.VO_VISION_ANGLE,Agent.position(1),...
        ...
        function obj = updategui(obj,Agents,nAgents)
            for iAgent = 1:nAgents
                ...
                [nx, ny] = createarc(Agents{iAgent}.heading + ...
                    AgentConstants.VO_VISION_ANGLE,Agents{iAgent}.heading - ...
                    AgentConstants.VO_VISION_ANGLE,Agents{iAgent}.position(1),...
